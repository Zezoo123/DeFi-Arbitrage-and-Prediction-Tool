...
def get_uniswap_router_contract():
    ...
    uniswap_router_abi = load_abi_json(f"fetch/{uniswap_router_abi_json_fh}")
    if uniswap_router_abi:
        ...
        return uniswap_router_contract
    return None
...
def get_uniswap_price(token_code, token_address):
    ...
    uniswap_router_contract (Contract): The Uniswap router contract instance.
